  ...
  return (
    <div>
      ...
      <form className="mb-4 font-primary w-full" onSubmit={handleSubmit}>
        ...
        <input type="text" className="outline-none bg-transparent border border-zinc-200 mb-8 rounded p-4 w-[500px] text-slate-300 placeholder:text-slate-300 " placeholder="what do you have to do today?" onChange={(e) => setValue(e.target.value) }value={value}/>
